...
$temp_dir = ".temp"
$gjf_path = ".\$($temp_dir)\google-java-format-1.9-all-deps.jar"
$gjf_release_url = "https://github.com/google/google-java-format/releases/download/google-java-format-1.9/google-java-format-1.9-all-deps.jar"
